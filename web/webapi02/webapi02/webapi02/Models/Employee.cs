...
namespace webapi02.Models
{
    public class Employee : ICloneable
    {
        ...
        // Controller --> Http, GET
        public Employee GetEmployeeById(String FirstName, String LastName)
        {
            Employee e = new Employee();
            String strQueryByName = "SELECT * FROM Employee WHERE FirstName = '{0}'" +
                " AND LastName = '{1}'";
        ...
        public Employee CreateEmployee(Employee e)
        {
            ...
            using (SqlCommand dbCmd = new SqlCommand(strInsertObj, dbCon))
            {
                ...
                if (nRowsAffected != 1) throw new Exception(
                    "Should inserted one row, but actually, it didn't.");
            }

            return GetEmployeeById(e.Id);
        }
