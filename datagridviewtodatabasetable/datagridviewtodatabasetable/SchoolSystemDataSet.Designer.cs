...
namespace DatagridViewtoDatabaseTable {
    ...
    public partial class SchoolSystemDataSet : global::System.Data.DataSet {
        ...
        public partial class StudentsDataTable : global::System.Data.TypedTableBase<StudentsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public StudentsRow AddStudentsRow(int ID, string Name, string Gender, int Age, int Grade) {
...
namespace DatagridViewtoDatabaseTable.SchoolSystemDataSetTableAdapters {
    ...
    public partial class StudentsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Students] WHERE (([ID] = @Original_ID) AND ([Name] = @Original" +
                "_Name) AND ([Gender] = @Original_Gender) AND ([Age] = @Original_Age) AND ([Grade" +
                "] = @Original_Grade))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Students] ([ID], [Name], [Gender], [Age], [Grade]) VALUES (@ID" +
                ", @Name, @Gender, @Age, @Grade);\r\nSELECT ID, Name, Gender, Age, Grade FROM Stude" +
                "nts WHERE (ID = @ID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Students] SET [ID] = @ID, [Name] = @Name, [Gender] = @Gender, [Age] = @Age, [Grade] = @Grade WHERE (([ID] = @Original_ID) AND ([Name] = @Original_Name) AND ([Gender] = @Original_Gender) AND ([Age] = @Original_Age) AND ([Grade] = @Original_Grade));
SELECT ID, Name, Gender, Age, Grade FROM Students WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::DatagridViewtoDatabaseTable.Properties.Settings.Default.SchoolSystemConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Name, Gender, Age, Grade FROM dbo.Students";
        ...
        public virtual int Delete(int Original_ID, string Original_Name, string Original_Gender, int Original_Age, int Original_Grade) {
        ...
        public virtual int Insert(int ID, string Name, string Gender, int Age, int Grade) {
        ...
        public virtual int Update(int ID, string Name, string Gender, int Age, int Grade, int Original_ID, string Original_Name, string Original_Gender, int Original_Age, int Original_Grade) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Gender, int Age, int Grade, int Original_ID, string Original_Name, string Original_Gender, int Original_Age, int Original_Grade) {
            return this.Update(Original_ID, Name, Gender, Age, Grade, Original_ID, Original_Name, Original_Gender, Original_Age, Original_Grade);
        }
    }
